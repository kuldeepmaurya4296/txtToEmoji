...
function btnClicking() {
    ...
    document.querySelector("#dec-btn").addEventListener("click", function () {
        ...
        document.querySelector("#dec-btn").style.backgroundColor = "#084b8f"
        document.querySelector("#enc-btn").style.backgroundColor = "#253b67"
    ...
    document.querySelector("#enc-btn").addEventListener("click", function () {
        ...
        document.querySelector("#dec-btn").style.backgroundColor = "#253b67"
        document.querySelector("#enc-btn").style.backgroundColor = "#084b8f"
